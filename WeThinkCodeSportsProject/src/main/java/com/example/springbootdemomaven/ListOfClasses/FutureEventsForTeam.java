...
public class FutureEventsForTeam {
    ...
    public FutureEventsForTeam(MongoDatabase mongoDatabase, String TeamID) {
        this.TeamID = TeamID;
    ...
    public String CreateURL() {
        return this.API + this.APIkey + this.field + this.TeamID;
    }

    public void APIListEvents(String url) {
        try {
            JsonObject jsonObject;
            jsonObject = this.database.checkIfDocumentExists(this.TeamID, "FutureTeamEvents");
            if (jsonObject == null) {
