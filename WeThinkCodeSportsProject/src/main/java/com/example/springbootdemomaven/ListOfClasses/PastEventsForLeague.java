...
public class PastEventsForLeague {
    ...
    public PastEventsForLeague(MongoDatabase mongoDatabase, String LeagueID){
    ...
    public void APIListEvents(String url){
        try
        {
            ...
            jsonObject = this.database.checkIfDocumentExists(this.LeagueID,"PastLeagueEvents");
            if (jsonObject == null) {
